...
export type SidebarButtonPositionModifiers = 'sidebar__button--is-bottom-center' |
...
const SIDEBAR_IS_FLOATING: SidebarFloatingVariantModifiers = 'sidebar--is-floating'
...
const HELPER_FULL_VIEW_WIDTH:HelperWidthModifiers = 'helper--is-full-view-width'
const HELPER_FULL_VIEW_HEIGHT:HelperHeightModifiers = 'helper--is-full-view-height'
...
function Button({
  ...
  const className = classNames(
    ...
    ], { variants: [`sidebar__button--is-${isPosition}` as SidebarButtonPositionModifiers], hasColor }
  )
  return (
    <button
