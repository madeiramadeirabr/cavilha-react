...
function TextField(_a) {
    ...
    const Icon = ({ direction, children }) => (react_1.default.createElement("span", { className: `${TextFieldElements["icon"]} ${TextFieldElements["icon"]}--is-${direction}` }, children));
    return (react_1.default.createElement("div", { className: className },
        react_1.default.createElement("label", null,
            hasIconLeft || react_1.default.createElement(Icon, { direction: "left" }, hasIconLeft),
            hasType === 'textarea' ?
                (react_1.default.createElement("textarea", Object.assign({}, props, { required: true })))
                : (react_1.default.createElement("input", Object.assign({ type: inputMode || 'text' }, props, { required: true }))),
            react_1.default.createElement("span", { className: TextFieldElements["label"] }, label),
            helper ?
                react_1.default.createElement("span", { className: TextFieldElements["helper"] }, helper)
                : null,
