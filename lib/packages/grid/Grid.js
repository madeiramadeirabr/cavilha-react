...
function Row(_a) {
    ...
    var className = classNames_1.classNames([GridElements.row, isReverse ? 'grid__row--is-reverse' : ''], {
        variants: variants,
        helpers: helpers,
        customCss: customCss
    });
...
function Column(_a) {
    ...
    return (react_1.default.createElement("div", __assign({}, props, { className: classNames_1.classNames(__spreadArrays([GridElements.column], sizes), { variants: variants, helpers: helpers, customCss: customCss }) }), children || ''));
}
