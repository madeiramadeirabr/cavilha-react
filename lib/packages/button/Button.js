...
var Button = function (_a, ref) {
    ...
    if (isAnchor) {
        return (react_1.default.createElement("a", __assign({}, props, { href: href, className: className }), content));
    }
    return (react_1.default.createElement("button", __assign({}, props, { type: "button", className: className }), content));
};
exports.Button = Button;
var ButtonForwardRef = react_1.forwardRef(Button);
var ButtonWithRef = function (_a) {
    var buttonRef = _a.buttonRef, props = __rest(_a, ["buttonRef"]);
    return react_1.default.createElement(ButtonForwardRef, __assign({}, props, { ref: buttonRef }));
};
exports.ButtonWithRef = ButtonWithRef;
