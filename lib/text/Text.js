...
function Text(_a) {
    var { hasElement, hasColor, hasBackground, hasText = 'body-one-regular', variants, helpers, hasClassName, children, withMarginFix, withPlaceholder } = _a, props = __rest(_a, ["hasElement", "hasColor", "hasBackground", "hasText", "variants", "helpers", "hasClassName", "children", "withMarginFix", "withPlaceholder"]);
