...
function Text(_a) {
    ...
    var className = classNames(['text', "text--is-" + isText], {
    ...
    if (type instanceof HTMLSpanElement) {
        return (React.createElement("span", __assign({}, props, { className: className }), children));
    }
    return (React.createElement("div", { className: "helper--has-margin-fix" },
        React.createElement("p", __assign({}, props, { className: className }), children)));
}
export { Text };
