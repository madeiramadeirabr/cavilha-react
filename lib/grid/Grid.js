...
function Column(_a) {
    ...
    return (react_1.default.createElement("div", Object.assign({}, props, { className: classNames_1.classNames([GridElements.column, ...sizes], { variants, helpers, hasClassName }) }), children || ''));
}
