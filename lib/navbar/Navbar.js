...
Navbar.Container = function (_a) {
    ...
    return (react_1.default.createElement("div", Object.assign({}, props, { className: classNames_1.classNames([types_1.NavbarElements.container], {}) }), children));
};
Navbar.Menu = function (_a) {
    var { isOpen, helpers } = _a, props = __rest(_a, ["isOpen", "helpers"]);
    const className = classNames_1.classNames([types_1.NavbarElements.menu], { helpers });
...
Navbar.Logo = function (_a) {
    ...
    const className = classNames_1.classNames([types_1.NavbarElements.logo], {});
...
Navbar.LogoHOC = function (_a) {
    var { title, src } = _a, props = __rest(_a, ["title", "src"]);
    const className = classNames_1.classNames([types_1.NavbarElements.logo], {});
    return (Component) => (react_1.default.createElement(Component, Object.assign({}, props, { className: className }),
        react_1.default.createElement("img", { src: src, alt: title || '' })));
};
Navbar.Items = function (_a) {
    ...
    const className = classNames_1.classNames([types_1.NavbarElements.items], {
        helpers: hidden,
    });
...
Navbar.Item = function (_a) {
    ...
    const className = classNames_1.classNames([types_1.NavbarElements.item, isActive ? 'navbar__item--is-active' : null], {});
    return (react_1.default.createElement("a", Object.assign({}, props, { className: className }), children));
};
Navbar.ItemHOC = function (_a) {
    var { isActive, children } = _a, props = __rest(_a, ["isActive", "children"]);
    const className = classNames_1.classNames([types_1.NavbarElements.item, isActive ? 'navbar__item--is-active' : null], {});
    return (Component) => (react_1.default.createElement(Component, Object.assign({}, props, { className: className }), children));
};
