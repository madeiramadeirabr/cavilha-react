...
})(NavbarElements = exports.NavbarElements || (exports.NavbarElements = {}));
function Navbar(_a) {
...
Navbar.Item = function (_a) {
    ...
    const className = classNames_1.classNames([NavbarElements.item, isActive ? 'navbar__item--is-active' : null], {});
